 ...
 *
 *      $Id: func/mail.php 2012-06-14 00:04:00 Beijing tengattack $
 */
...
require_once EI_ROOT.'src/inc/mail.php';
...
EOT;
	...
	if($_G['setting']['mail']['mailsend'] == 1) {
		...
		return stmp_mail($mats[1], $email_subject, $email_message, $mats[2]);
	}
}
