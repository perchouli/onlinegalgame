 ...
 *
 *      $Id: class/table/common_member.php 2012-06-14 09:10:00 Beijing tengattack $
 */
...
class table_common_member extends ei_table_archive
{
	...
	public function split($splitnum, $iscron = false) {
		...
		@set_time_limit(0);
		ei_database_safecheck::setconfigstatus(0);
		$dateline = TIMESTAMP - 7776000;//60*60*24*90
