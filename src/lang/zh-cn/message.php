...
$lang = array (
  ...
  'logout_succeed' => '您已退出站点，现在将以游客身份转入退出前页面，请稍候…… <br /> {ucsynlogout} ',
  ...
  'antiactivate_succeed' => '您好，{username}，您的帐号已被成功反激活，现在将转入站点首页',
  ...
  'event_signup' => '拥有了自己的封绝',
  'event_story' => '创作了故事 <a href="story.php?mod=show&id={id}">{name}</a> ',
  'event_scene' => '书写了场景 <a href="story.php?mod=show&id={id}&ssid={ssid}">{name} - {scenename}</a> ',
  'event_role' => '创建了角色 <a href="role.php?mod=show&id={id}">{name}</a> ',
