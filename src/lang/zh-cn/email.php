 ...
 *
 *      $Id: lang/zh-cn/email.php 2012-06-14 12:03:00 Beijing tengattack $
 */
...
{siteurl}</p>',
	...
	'email_password_reset_subject' =>	'密码重设地址',
	'email_password_reset_message' =>	'<br />
<p>这封信是由 {bbname} 发送的。</p>

<p>您收到这封邮件，是由于在 {bbname} 申请了重新设置密码，并使用
了这个邮箱地址。如果您并没有访问过 {bbname}，或没有进行上述操作，请忽
略这封邮件。您不需要退订或进行其他进一步的操作。</p>
<br />
----------------------------------------------------------------------<br />
<strong>密码重设说明</strong><br />
----------------------------------------------------------------------<br />
<br />
<p>如果您是 {bbname} 的用户，并申请了重新设置密码，我们需要对您的身份有
效性进行验证以避免您的账号被滥用。</p>

<p>您只需点击下面的链接即可进行密码重设，以下链接有效期为3天。过期可以重新请求发送一封新的密码重设邮件：<br />
