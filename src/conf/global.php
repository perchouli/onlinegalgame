 ...
 *
 *      $Id: conf/global.php 2012-06-13 11:57:00 Beijing tengattack $
 */
...
$_config['db'][1]['dbuser']  		= 'ei';
$_config['db'][1]['dbpw'] 	 	= 'yQrVKZXv3jbMXBXV';
$_config['db'][1]['dbcharset'] 		= 'utf8';
$_config['db'][1]['pconnect'] 		= 0;
$_config['db'][1]['dbname']  		= 'ei';
$_config['db'][1]['tablepre'] 		= 'ei_';
...
// COOKIE 设置
$_config['cookie']['cookiepre'] 		= 'ei_'; 	// COOKIE前缀
